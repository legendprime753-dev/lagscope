...
public final class RedstoneLimiterModule extends AbstractModule {
    ...
    private final Listener listener = new Listener() {
        ...
        public void onRedstone(BlockRedstoneEvent e) {
            ...
            int maxToggles = plugin.getConfig().getInt("modules.RedstoneLimiterModule.max_toggles_per_second", controller.getMode() == LagMode.EXTREME ? 6 : 12);
    ...
    private static long pack(Location l) {
        long w = l.getWorld() == null ? 0 : l.getWorld().getUID().getMostSignificantBits();
